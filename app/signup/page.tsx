...
export default async function SignupPage({ searchParams }: PageProps) {
  ...
  <OAuthSubmitButton label={t.google_signup} loadingLabel="Connecting..." />
</form>
            ...
            <p className="mt-6 text-center text-sm text-slate-600">
              {t.login_prompt}{" "}
              <Link href={`/login${nextQuery}`} className="font-medium text-slate-900 underline">
                {t.login_link}
              </Link>
            </p>
          </div>
