...
export const metadata: Metadata = {
  title: "Städjobb Malmö 2026 | Hitta jobb som städare",
  description:
  ...
  openGraph: {
    title: "Städjobb Malmö | Clean Jobs",
    description:
  ...
  twitter: {
    ...
    title: "Städjobb Malmö | Clean Jobs",
    description:
      "Hitta arbete som städare i Malmö via Clean Jobs.",
    images: ["/og-image.png"],
  },
}
...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Hur hittar jag städjobb i Malmö?",
      acceptedAnswer: {
        "@type": "Answer",
        text:
    ...
    {
      "@type": "Question",
      name: "Vilka typer av städjobb finns i Malmö?",
      acceptedAnswer: {
        "@type": "Answer",
        text:
...
export default function StadjobbMalmoPage() {
  return (
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-12">
        <section className="rounded-[36px] border border-slate-200 bg-gradient-to-br from-white via-white to-rose-50/50 p-6 shadow-[0_2px_14px_rgba(15,23,42,0.04)] md:p-10">
          ...
          <p className="mt-5 max-w-3xl text-base leading-7 text-slate-600 md:text-lg">
            Malmö har många möjligheter för städare, städfirmor och personer som
            söker extrajobb eller deltidsjobb inom städning. Clean Jobs gör det
            enklare att hitta hemstädning, kontorsstädning, flyttstädning och
        ...
        <div className="mt-8 grid gap-6">
          <Section eyebrow="Guide" title="Vad innebär städjobb i Malmö?">
            <p>
              Städjobb i Malmö kan vara korta uppdrag i privata hem, regelbunden
          ...
          <section className="grid gap-5 md:grid-cols-3">
            ...
            <StepCard
              number="2"
              title="Sök uppdrag"
              text="Bläddra bland städjobb i Malmö och välj uppdrag som passar din tid och plats."
            />
            <StepCard
              number="3"
          ...
          <Section eyebrow="Arbetstyper" title="Vanliga städjobb i Malmö">
            <p>
          ...
          <Section eyebrow="Områden" title="Sök städjobb i Malmö med omnejd">
            <p>
              Det finns möjligheter både i centrala Malmö och i områden som
              Limhamn, Hyllie, Västra Hamnen, Rosengård, Lund, Trelleborg,
              Staffanstorp, Burlöv, Lomma och Vellinge. Om du kan resa mellan
              flera områden ökar dina chanser att hitta uppdrag.
            </p>
          ...
          <Section eyebrow="För kunder" title="Så hittar du rätt städare i Malmö">
            <p>
