...
const copy = {
  uk: {
    ...
    metaDescription:
      "Знайдіть роботу з прибирання в Гетеборзі. Гід по прибиранню дому, офісу, після переїзду, підробітку та роботі прибиральником.",
    metaOgTitle: "Робота з прибирання в Гетеборзі | Clean Jobs",
    metaOgDescription:
      "Знайдіть роботу прибиральником у Гетеборзі або найміть прибиральника для дому, офісу чи прибирання після переїзду.",
    metaOgAlt: "Робота з прибирання в Гетеборзі",

    faqOneQuestion: "Як знайти роботу з прибирання в Гетеборзі?",
    faqOneAnswer:
      "Роботу з прибирання в Гетеборзі можна знайти через клінінгові компанії, локальні контакти, сайти вакансій і нішеві платформи, такі як Clean Jobs.",
    faqTwoQuestion: "Які типи робіт з прибирання є в Гетеборзі?",
    faqTwoAnswer:
    ...
    heroEyebrow: "Робота з прибирання в Гетеборзі",
    heroTitle:
      "Робота з прибирання в Гетеборзі: знайдіть роботу або найміть допомогу",
    heroText:
      "У Гетеборзі є багато можливостей для прибиральників, клінінгових компаній і людей, які шукають підробіток або часткову зайнятість у прибиранні. Clean Jobs допомагає простіше знаходити прибирання дому, офісу, після переїзду та регулярні замовлення.",
    findJobs: "Знайти роботи з прибирання",
    postJob: "Опублікувати роботу з прибирання",

    guideEyebrow: "Гід",
    guideTitle: "Що означає робота з прибирання в Гетеборзі?",
    guideText1:
      "Робота з прибирання в Гетеборзі може бути коротким завданням у приватному домі, регулярним прибиранням дому, офісу, після переїзду або допомогою після ремонту. Деяким клієнтам потрібна одноразова допомога, інші шукають людину для постійної роботи.",
    guideText2:
    ...
    stepTwoText:
      "Переглядайте роботи з прибирання в Гетеборзі та вибирайте ті, що підходять за часом і місцем.",
    ...
    areasEyebrow: "Райони",
    areasTitle: "Шукайте роботи з прибирання в Гетеборзі та поруч",
    areasText1:
      "Можливості є як у центрі Гетеборга, так і в районах Hisingen, Majorna, Linné, Frölunda, Angered, Mölndal, Partille, Lerum, Kungälv і Kungsbacka. Якщо ви можете їздити між кількома районами, шанси знайти завдання зростають.",
    areasText2:
    ...
    clientsTitle: "Як знайти правильного прибиральника в Гетеборзі",
    clientsText1:
    ...
    ctaTitle: "Почніть знаходити роботи з прибирання в Гетеборзі",
    ctaText:
  ...
  ru: {
    ...
    metaDescription:
      "Найдите работу по уборке в Гётеборге. Гид по уборке дома, офиса, после переезда, подработке и работе уборщиком.",
    metaOgTitle: "Работа по уборке в Гётеборге | Clean Jobs",
    metaOgDescription:
      "Найдите работу уборщиком в Гётеборге или наймите уборщика для дома, офиса и уборки после переезда.",
    metaOgAlt: "Работа по уборке в Гётеборге",

    faqOneQuestion: "Как найти работу по уборке в Гётеборге?",
    faqOneAnswer:
      "Работу по уборке в Гётеборге можно найти через клининговые компании, локальные контакты, сайты вакансий и нишевые платформы, такие как Clean Jobs.",
    faqTwoQuestion: "Какие типы работ по уборке есть в Гётеборге?",
    faqTwoAnswer:
    ...
    heroEyebrow: "Работа по уборке в Гётеборге",
    heroTitle:
      "Работа по уборке в Гётеборге: найдите работу или наймите помощь",
    heroText:
      "В Гётеборге есть много возможностей для уборщиков, клининговых компаний и людей, которые ищут подработку или частичную занятость в уборке. Clean Jobs помогает проще находить уборку дома, офиса, после переезда и регулярные задания.",
    findJobs: "Найти работы по уборке",
    postJob: "Опубликовать работу по уборке",

    guideEyebrow: "Гид",
    guideTitle: "Что означает работа по уборке в Гётеборге?",
    guideText1:
      "Работа по уборке в Гётеборге может быть коротким заданием в частном доме, регулярной уборкой дома, офиса, после переезда или помощью после ремонта. Некоторым клиентам нужна разовая помощь, другие ищут человека для постоянной работы.",
    guideText2:
    ...
    stepTwoText:
      "Просматривайте работы по уборке в Гётеборге и выбирайте те, которые подходят по времени и месту.",
    ...
    areasEyebrow: "Районы",
    areasTitle: "Ищите работы по уборке в Гётеборге и рядом",
    areasText1:
      "Возможности есть как в центре Гётеборга, так и в районах Hisingen, Majorna, Linné, Frölunda, Angered, Mölndal, Partille, Lerum, Kungälv и Kungsbacka. Если вы можете ездить между несколькими районами, шансы найти задания растут.",
    areasText2:
    ...
    clientsTitle: "Как найти подходящего уборщика в Гётеборге",
    clientsText1:
    ...
    ctaTitle: "Начните находить работы по уборке в Гётеборге",
    ctaText:
  ...
  en: {
    metaTitle: "Cleaning Jobs Gothenburg 2026 | Find Cleaner Work",
    metaDescription:
      "Find cleaning jobs in Gothenburg. Guide to home cleaning, office cleaning, move-out cleaning, extra work and cleaner jobs in Gothenburg.",
    metaOgTitle: "Cleaning Jobs Gothenburg | Clean Jobs",
    metaOgDescription:
      "Find cleaning jobs in Gothenburg or hire cleaners for home cleaning, office cleaning and move-out cleaning.",
    metaOgAlt: "Cleaning Jobs Gothenburg",

    faqOneQuestion: "How do I find cleaning jobs in Gothenburg?",
    faqOneAnswer:
      "You can find cleaning jobs in Gothenburg through cleaning companies, local contacts, job sites and niche platforms such as Clean Jobs.",
    faqTwoQuestion: "What types of cleaning jobs are available in Gothenburg?",
    faqTwoAnswer:
      "Common cleaning jobs in Gothenburg include home cleaning, office cleaning, move-out cleaning, deep cleaning and recurring cleaning assignments.",
    ...
    heroEyebrow: "Cleaning jobs Gothenburg",
    heroTitle:
      "Cleaning jobs in Gothenburg: find cleaner work or hire cleaning help",
    heroText:
      "Gothenburg has many opportunities for cleaners, cleaning companies and people looking for extra work or part-time work in cleaning. Clean Jobs makes it easier to find home cleaning, office cleaning, move-out cleaning and recurring assignments.",
    findJobs: "Find cleaning jobs",
    postJob: "Post cleaning job",

    guideEyebrow: "Guide",
    guideTitle: "What do cleaning jobs in Gothenburg include?",
    guideText1:
      "Cleaning jobs in Gothenburg can be short assignments in private homes, regular home cleaning, office cleaning, move-out cleaning or help after renovation. Some clients need help once, while others are looking for someone for recurring work.",
    guideText2:
    ...
    stepTwoText:
      "Browse cleaning jobs in Gothenburg and choose assignments that fit your time and location.",
    ...
    areasEyebrow: "Areas",
    areasTitle: "Search cleaning jobs in Gothenburg and nearby areas",
    areasText1:
      "There are opportunities both in central Gothenburg and in areas such as Hisingen, Majorna, Linné, Frölunda, Angered, Mölndal, Partille, Lerum, Kungälv and Kungsbacka. If you can travel between several areas, your chances of finding assignments increase.",
    areasText2:
    ...
    clientsTitle: "How to find the right cleaner in Gothenburg",
    clientsText1:
    ...
    ctaTitle: "Start finding cleaning jobs in Gothenburg",
    ctaText:
  ...
  sv: {
    metaTitle: "Städjobb Göteborg 2026 | Hitta jobb som städare",
    metaDescription:
    ...
    heroEyebrow: "Städjobb Göteborg",
    heroTitle:
      "Städjobb i Göteborg: hitta arbete som städare eller anlita städhjälp",
    heroText:
      "Göteborg har många möjligheter för städare, städfirmor och personer som söker extrajobb eller deltidsjobb inom städning. Clean Jobs gör det enklare att hitta hemstädning, kontorsstädning, flyttstädning och återkommande uppdrag.",
    findJobs: "Hitta städjobb",
    postJob: "Lägg upp städjobb",

    guideEyebrow: "Guide",
    guideTitle: "Vad innebär städjobb i Göteborg?",
    guideText1:
      "Städjobb i Göteborg kan vara korta uppdrag i privata hem, regelbunden hemstädning, kontorsstädning, flyttstädning eller hjälp efter renovering. Vissa kunder behöver hjälp en gång, medan andra söker någon för återkommande arbete.",
    guideText2:
    ...
    stepTwoText:
      "Bläddra bland städjobb i Göteborg och välj uppdrag som passar din tid och plats.",
    ...
    areasTitle: "Sök städjobb i Göteborg med omnejd",
    areasText1:
      "Det finns möjligheter både i centrala Göteborg och i områden som Hisingen, Majorna, Linné, Frölunda, Angered, Mölndal, Partille, Lerum, Kungälv och Kungsbacka. Om du kan resa mellan flera områden ökar dina chanser att hitta uppdrag.",
    areasText2:
    ...
    clientsTitle: "Så hittar du rätt städare i Göteborg",
    clientsText1:
    ...
    ctaTitle: "Börja hitta städjobb i Göteborg",
    ctaText:
  ...
  pl: {
    metaTitle: "Prace sprzątania Göteborg 2026 | Clean Jobs",
    metaDescription:
      "Znajdź prace sprzątania w Göteborgu. Poradnik o sprzątaniu domu, biura, po przeprowadzce, pracy dodatkowej i pracy jako sprzątacz.",
    metaOgTitle: "Prace sprzątania Göteborg | Clean Jobs",
    metaOgDescription:
      "Znajdź prace sprzątania w Göteborgu albo zatrudnij sprzątacza do domu, biura i sprzątania po przeprowadzce.",
    metaOgAlt: "Prace sprzątania Göteborg",

    faqOneQuestion: "Jak znaleźć prace sprzątania w Göteborgu?",
    faqOneAnswer:
      "Prace sprzątania w Göteborgu można znaleźć przez firmy sprzątające, lokalne kontakty, portale pracy i niszowe platformy takie jak Clean Jobs.",
    faqTwoQuestion: "Jakie typy prac sprzątania są w Göteborgu?",
    faqTwoAnswer:
    ...
    heroEyebrow: "Prace sprzątania Göteborg",
    heroTitle:
      "Prace sprzątania w Göteborgu: znajdź pracę albo zatrudnij pomoc",
    heroText:
      "Göteborg ma wiele możliwości dla sprzątaczy, firm sprzątających i osób szukających pracy dodatkowej lub części etatu w sprzątaniu. Clean Jobs ułatwia znajdowanie sprzątania domu, biura, po przeprowadzce i regularnych zleceń.",
    findJobs: "Znajdź prace sprzątania",
    postJob: "Dodaj pracę sprzątania",

    guideEyebrow: "Poradnik",
    guideTitle: "Co oznaczają prace sprzątania w Göteborgu?",
    guideText1:
      "Prace sprzątania w Göteborgu mogą być krótkimi zleceniami w prywatnych domach, regularnym sprzątaniem domu, biura, po przeprowadzce albo pomocą po remoncie. Niektórzy klienci potrzebują jednorazowej pomocy, inni szukają osoby do stałej pracy.",
    guideText2:
    ...
    stepTwoText:
      "Przeglądaj prace sprzątania w Göteborgu i wybieraj zlecenia pasujące do Twojego czasu i miejsca.",
    ...
    areasTitle: "Szukaj prac sprzątania w Göteborgu i okolicy",
    areasText1:
      "Możliwości są zarówno w centrum Göteborga, jak i w obszarach takich jak Hisingen, Majorna, Linné, Frölunda, Angered, Mölndal, Partille, Lerum, Kungälv i Kungsbacka. Jeśli możesz dojeżdżać między kilkoma obszarami, zwiększasz szanse na zlecenia.",
    areasText2:
    ...
    clientsTitle: "Jak znaleźć właściwego sprzątacza w Göteborgu",
    clientsText1:
    ...
    ctaTitle: "Zacznij znajdować prace sprzątania w Göteborgu",
    ctaText:
...
export default async function StadjobbGoteborgPage() {
  const locale = await getLocale()
  const t = copy[locale]
    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-12">
        ...
        <div className="mt-8 grid gap-6">
          ...
          <RelatedGuides currentPath="/stadjobb-goteborg" />
        </div>
      </main>
    </div>
  )
