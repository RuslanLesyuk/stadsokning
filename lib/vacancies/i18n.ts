...
const dictionaries: Record<Locale, VacancyDictionary> = {
  ...
  en: {
    ...
    dashboard: { eyebrow: "Job marketplace", title: "My job ads", add: "Add ad", empty: "You have not published any job ads yet.", active: "Active", closed: "Closed", offerBadge: "Offering job", seekerBadge: "Looking for work", view: "View", edit: "Edit", close: "Close ad", delete: "Delete", deleteConfirm: "Permanently delete this ad? Any applications to it will also be deleted.", applications: "Applications", noApplications: "No applications yet.", seekerDirectContact: "Employers contact you directly using the contact details in your ad.", published: "Published" },
  ...
  uk: {
    ...
    dashboard: { eyebrow: "Ринок роботи", title: "Мої оголошення", add: "Додати оголошення", empty: "Ви ще не опублікували жодного оголошення.", active: "Активне", closed: "Закрите", offerBadge: "Пропоную вакансію", seekerBadge: "Шукаю роботу", view: "Переглянути", edit: "Редагувати", close: "Закрити оголошення", delete: "Видалити", deleteConfirm: "Видалити це оголошення назавжди? Усі відгуки на нього також буде видалено.", applications: "Відгуки", noApplications: "Відгуків поки немає.", seekerDirectContact: "Роботодавці зв’язуються з вами напряму за контактами, вказаними в оголошенні.", published: "Опубліковано" },
