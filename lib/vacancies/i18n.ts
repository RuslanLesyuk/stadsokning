...
const dictionaries: Record<Locale, VacancyDictionary> = {
  sv: {
    ...
    dashboard: { eyebrow: "Arbetsgivare", title: "Mina lediga jobb", add: "Lägg till jobb", empty: "Du har inte publicerat några lediga jobb ännu.", active: "Aktiv", closed: "Stängd", view: "Visa", edit: "Redigera", close: "Stäng jobb", delete: "Ta bort", deleteConfirm: "Ta bort den här jobbannonsen permanent? Alla ansökningar till annonsen tas också bort.", applications: "Ansökningar", noApplications: "Inga ansökningar ännu." },
  ...
  en: {
    ...
    dashboard: { eyebrow: "Employer", title: "My vacancies", add: "Add vacancy", empty: "You have not published any vacancies yet.", active: "Active", closed: "Closed", view: "View", edit: "Edit", close: "Close vacancy", delete: "Delete", deleteConfirm: "Permanently delete this vacancy? All applications to it will also be deleted.", applications: "Applications", noApplications: "No applications yet." },
  ...
  uk: {
    ...
    dashboard: { eyebrow: "Роботодавець", title: "Мої вакансії", add: "Додати вакансію", empty: "Ви ще не опублікували жодної вакансії.", active: "Активна", closed: "Закрита", view: "Переглянути", edit: "Редагувати", close: "Закрити вакансію", delete: "Видалити", deleteConfirm: "Видалити цю вакансію назавжди? Усі відгуки на неї також буде видалено.", applications: "Відгуки", noApplications: "Відгуків поки немає." },
  ...
  ru: {
    ...
    dashboard: { eyebrow: "Работодатель", title: "Мои вакансии", add: "Добавить вакансию", empty: "Вы еще не опубликовали ни одной вакансии.", active: "Активна", closed: "Закрыта", view: "Посмотреть", edit: "Редактировать", close: "Закрыть вакансию", delete: "Удалить", deleteConfirm: "Удалить эту вакансию навсегда? Все отклики на неё также будут удалены.", applications: "Отклики", noApplications: "Откликов пока нет." },
  ...
  pl: {
    ...
    dashboard: { eyebrow: "Pracodawca", title: "Moje oferty pracy", add: "Dodaj ofertę", empty: "Nie opublikowano jeszcze żadnych ofert pracy.", active: "Aktywna", closed: "Zamknięta", view: "Zobacz", edit: "Edytuj", close: "Zamknij ofertę", delete: "Usuń", deleteConfirm: "Usunąć tę ofertę pracy na stałe? Wszystkie aplikacje do niej również zostaną usunięte.", applications: "Aplikacje", noApplications: "Brak aplikacji." },
